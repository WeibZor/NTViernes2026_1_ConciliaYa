#instalar las dos librerias y meterlas en el requierements.txt
...
RUTA_ASSETS = os.path.join(os.path.dirname(__file__), "..", "..", "mi-app-Front - Project", "src", "assets", "graficos")
