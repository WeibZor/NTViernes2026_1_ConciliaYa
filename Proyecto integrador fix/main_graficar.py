...
#en vez de consumir el back simulamos los datos
from notebook.consumo import consumir_servicios
#from utils.comsumo_usuario import generar_simulacion_usuarios
...
datos_tabla_servicios=consumir_servicios() #sustituir por simulaciones
